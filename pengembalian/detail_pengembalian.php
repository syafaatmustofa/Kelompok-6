                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    <td>Cover</td>
                                    <td><img src="../assets/img/<?php echo $data2['cover'] ?>" class="img-thumbnail"
                                            alt="" style="width: 100px;"></td>
                                </tr>
                                <tr>
                                    <td>Kode Buku</td>
                                    <td><input type="text" class="form-control" name="kode_buku"
                                            value="<?php echo $data2['id_buku'] ?>" disabled></input></td>
                                </tr>
                                <tr>
                                    <td>Judul</td>
                                    <td><input type="text" class="form-control" name="kode_buku"
                                            value="<?php echo $data2['judul'] ?>" disabled></input></td>
                                    </td>
                                <tr>
                                    <td>NIS</td>
                                    <td><input type="text" class="form-control" disabled name="nis"
                                            value="<?php echo $data2['nis'] ?>"></input></td>
                                </tr>
                                <tr>
                                    <td>Petugas</td>
                                    <td><input type="text" class="form-control" disabled name="nip"
                                            value="<?= $data2['nip'] ?>"></input></td>
                                </tr>
                                </tr>
                                </tr>
                                <tr>
                                    <td>Tanggal Peminjaman</td>
                                    <td><input type="date" class="form-control" disabled name="pinjam"
                                            value="<?= $data2['tanggal_peminjaman'] ?>"></input></td>
                                </tr>
                                <tr>
                                    <td>Tanggal Pengembalian</td>
                                    <td><input type="date" class="form-control" disabled name="kembali"
                                            value="<?= $data2['tanggal_pengembalian'] ?>"></input></td>
                                </tr>
                            </tbody>
                        </table>
                        <div class="text-end">
                            <a href="home_peminjaman.
php" type="button" class="btn btn-danger"> Kembali </a>
                        </div>
                    </form>
                </div>
            </div>
